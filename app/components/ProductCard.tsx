...
export const products: Product[] = [
  ...
  },
  {
    ...
    features: ["250", "הולכת חום", "תפרחת + מיצויים", "2600mAh", "מסך LED", "שנה אחת"],
  ...
  },
  {
    ...
    features: ["320", "קונבקציה (Convection)", "תפרחת", "3200mAh נשלפת", "OLED", "שנה אחת"],
  ...
  },
  {
    ...
    features: ["₪300", "קונבקציה (Convection)", "שולחני", "3200mAh נשלפת", "OLED צבעוני", "שנה אחת"],
